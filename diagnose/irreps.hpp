...
public:
  ...
  int operator<=>(const Littleirrep& rhs) const {
      assert(false);
  }
...
public:
  ...
  int operator<=>(const Irrep1wp& rhs) const{
      assert(false);
  }
  bool operator!=(const Irrep1wp& rhs) const{
      assert(false);
  }
...
public:
  ...
  int operator<=>(const Irrep12wp& rhs) const{
      assert(false);
      return false;
  }
...
public:
  ...
  int operator<=>(const Irrep1wpDecomp& ) const{
      assert(false);
      return false;
  }
...
public:
  ...
  int operator<=>(const Irrep12wpDecomp& ) const{
      assert(false);
      return false;
  }
...
public:
  ...
  int operator<=>(const LittleirrepDecomp& rhs) const{
      assert(false);
      return false;
  }
