...
def _kvectors_and_wp_to_site_irrep_to_little_irreps_map(group_number):
...
def _point_group_and_site_irrep_to_induced_little_irreps_map(group_number, wyckoff_label):
