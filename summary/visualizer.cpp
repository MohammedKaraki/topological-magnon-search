...
LabelPosition Visualizer::sublabel_position(int sub_e_idx, int num_sub_irreps) const {
...
void Visualizer::draw_cluster(double x,
                              double y,
                              double dot_diameter,
                              double theta_shift,
                              int subirrep_idx,
...
void Visualizer::draw_subirrep(double x,
                               double y,
                               int subirrep_idx,
...
void Visualizer::draw_superirrep(double x,
                                 double y,
...
std::vector<BrokenSupermode> make_broken_supermodes(
    const std::vector<diagnose2::Supermode> &supermodes,
    const std::vector<diagnose2::Submode> &submodes,
...
void Visualizer::annotate(int x_idx, std::ostringstream &output) {
...
void Visualizer::supervisualize_at_x_idx(int x_idx, std::ostringstream &output) {
...
void Visualizer::subvisualize_at_x_idx(int x_idx, std::ostringstream &output) {
    int subk_idx = x_idx_to_subk_idx(x_idx);
    int superk_idx = x_idx_to_superk_idx(x_idx);
...
void Visualizer::visualize_superlines(int x1_idx, int x2_idx, std::ostringstream &output) {
...
void Visualizer::visualize_sublines(int x1_idx, int x2_idx, std::ostringstream &output) {
...
int Visualizer::x_idx_to_subk_idx(int x_idx) {
    const auto subk_idx = drawn_subk_idxs[x_idx];

    return subk_idx;
}

int Visualizer::x_idx_to_superk_idx(int x_idx) {
