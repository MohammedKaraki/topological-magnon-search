...
# def ksymbol_from_irreplabel(irreplabel):
#     if irreplabel.startswith('('):
#         ALTERNATE_PATTERN = r'\(([A-Z]+)\)' + IRREP_PATTERN
#         m = fullmatch(ALTERNATE_PATTERN, irreplabel)
#     else:
#         m = fullmatch(IRREP_PATTERN, irreplabel)
#
