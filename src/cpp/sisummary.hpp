...
private:
  ...
  void increment_trivialorgapless()
  {
      ++trivialorgapless_count;
  }
...
public:
  ...
  int get_trivialorgapless_count() const
  {
    return trivialorgapless_count;
  }
  ...
  static SiSummary lower_bound(const SiSummary& l, const SiSummary& r)
  {
    ...
    result.trivialorgapless_count = std::min(result.trivialorgapless_count,
                                             r.trivialorgapless_count);
  ...
  static SiSummary upper_bound(const SiSummary& l, const SiSummary& r)
  {
    ...
    result.trivialorgapless_count = std::max(result.trivialorgapless_count,
                                             r.trivialorgapless_count);
